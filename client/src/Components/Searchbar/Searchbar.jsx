  ...
  const handlegen = (evento) =>{
   ...
   return (
      <div className={styles.container}>
          ...
          <input className={styles.barra} onChange={handleChange}
                  type="text"
           ...
           <span className={styles.opciones}>Filter by Origin&nbsp;
               <select name='order by origin' defaultValue='orderCharacter' onChange={handleid} className={styles.selector}>
                <option value="OrderCharacter" disabled='disable'>Order...</option>
           ...
           <span className={styles.opciones}>Filter by Genre&nbsp;
               <select name='order by origin' defaultValue='orderCharacter' onChange={handlegen} className={styles.selector}>
